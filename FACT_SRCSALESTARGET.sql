...
ROUND(TARGETSALESAMOUNT/365, 2) AS DAILY_TARGET FROM STAGE_TARGETDATACHANNELRESELLERSTORE) A
LEFT JOIN PUBLIC.DIM_STORE B ON A.TARGETNAME = CAST(B.STORENUMBER AS VARCHAR)
